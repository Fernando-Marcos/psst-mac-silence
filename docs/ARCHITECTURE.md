...
- `SilenceController.swift`: estado, activación, restauración y persistencia reversible.
...
La desactivación restaura la instantánea y abre el atajo inverso. Los dispositivos digitales que no exponen control de volumen por software pueden rechazar el cambio; Psst lo comunica sin intentar eludir macOS.
