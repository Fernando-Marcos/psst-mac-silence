...
El audio usa Core Audio. Durante el modo biblioteca, Psst vigila localmente las propiedades de la salida y vuelve a aplicar mute y volumen cero si cambian. No captura audio ni inyecta código en otras aplicaciones. Las acciones de Concentración o Bajo consumo quedan en Atajos, bajo control explícito del usuario. macOS mantiene íntegramente la protección térmica y el control de los ventiladores.
